...
<body>
    ...
    <div class="contion">
        ...
        <div id="container">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="information_t col-md-12">
                        <span>学生姓名：<?php $s_user=$this->session->userdata('s_user'); if(isset($s_user)){echo $s_user['s_name'];}?></span>
                        <span>年级：<?php $s_user=$this->session->userdata('s_user'); if(isset($s_user)){echo $s_user['grade'];}?></span>
                        <span>班级:<?php $s_user=$this->session->userdata('s_user'); if(isset($s_user)){echo $s_user['major'];}?></span>
                    </div>
                    ...
                    <div class="class-list col-md-8 col-md-offset-2">
                        <table class="table table-striped">
                            ...
                            <tr v-for="obj in resultList">
                                <td>{{obj.c_id}}</td>
                                <td>{{obj.c_name}}</td>
                                <td class="sub" data-toggle="modal" data-target="#myModal1" @click="choose">删除</td>
                            </tr>
                        </table>
    ...
    <script>
        var vm =new Vue({
            ...
            mounted:function () {
                var _this=this;
                $.getJSON('student/choice_list?callback=?',function (res) {
                    _this.resultAll = res;
            ...
            methods:{
                ...
                confirm:function (e) {
                    var _this = this;
                    var cid=_this.c_id;
                    $.post('student/delete_c',{c_id:cid},function (res) {
                        if(res==1){
                            $.getJSON('student/choice_list?callback=?',function (res) {
