                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <label>生成文档名：
                                    <input type="text" id='word-name' placeholder="自测题" class="form-control" v-model="wordName">
                                </label>
                            ...
                            <div class="modal-body">
                                ...
                                <div v-for='(oCheck,index) in testPaper.check_paper'>
                                    ...
                                    <span >C.{{oCheck.opd}}</span>
                                    <span >正确答案:{{oCheck.true}}</span>
                                </div>
                            </div>
